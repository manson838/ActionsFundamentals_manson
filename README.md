...
- [v] Introduction and Icebreaker
- [v] GitHub Actions Fundamentals
- [v] The YAML syntax
- [v] Basic workflow syntax
- [v] Events that trigger workflow
- [v] Jobs and steps
- [v] :mag: Demo: Creating a workflow
- [v] 🔨 Hands-on: [My first Action workflow](hol/01-My-first-workflow.md)
